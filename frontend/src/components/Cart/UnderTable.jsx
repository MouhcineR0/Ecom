...
function UnderTable({ Total }) {
    ...
    return (
        <div className='mx-auto w-full container flex mt-8 font-poppins justify-between flex-col md:flex-row items-center md:items-start gap-5 md:gap-0'>
            ...
            <div className="Cart-total flex flex-col border-[1.5px] border-black p-5 rounded-md md:w-[40%] w-[70%]">
                ...
                <Button Name={'Process to checkout'} className={'text-center self-center mt-2'} />
            </div>
        </div >
    );
}
