...
const aiStyle = "bg-primary py-3 px-3 text-white flex self-start rounded-md max-w-[70%] shadow-sm break-all";
			...
			{ChatVisibility &&
				(
					<div className='w-[450px] h-[500px] bg-white right-7 bottom-24 rounded-md fixed z-[999] shadow-lg flex flex-col'>
						...
						<div id='discussions' className='discussions h-full w-full overflow-y-scroll flex flex-col p-2 gap-1'>
							{/* hna conversation */}
						</div>
						<div className='text-black w-full'>
							<form action="" onSubmit={handleSubmit}>
								<input type="text" value={Content} onChange={(e) => setContent(e.target.value)} id="" className='fixed w-full px-3 py-2 hover:shadow-[0_-7px_29px_rgba(100,100,111,0.2)] transition-all border-t-[1px] focus:outline-none outline-none focus:border-0' placeholder='Type and press [enter]..' />
							</form>
						</div>
					</div >
				)
